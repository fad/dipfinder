...
export function buildOnYourRadarBlock(candidates: RadarCandidate[], isPro: boolean): string {
  ...
  const header = `<h2 style="margin:14px 0 10px;padding-bottom:8px;font-size:0.7em;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:0.08em;border-bottom:1px solid #f1f5f9;text-align:left;">On Your Radar</h2>`;
