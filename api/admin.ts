...
function buildDummyVars(token: string): Record<string, string> {
  ...
  return {
    ...
    weekAhead: `<div style="margin-top:24px;background:#ffffff;border:1px solid #e2e8f0;border-radius:10px;padding:4px 16px 14px;text-align:left;"><h2 style="margin:14px 0 2px;font-size:0.7em;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:0.08em;">The week ahead</h2><p style="margin:8px 0 6px;font-size:0.8em;color:#64748b;font-style:italic;">Earnings on your watchlist:</p><table cellpadding="0" cellspacing="0" style="border-collapse:collapse;"><tr><td style="padding:6px 12px 6px 0;font-size:0.875em;color:#1e293b;font-weight:700;white-space:nowrap;vertical-align:top;">AAPL</td><td style="padding:6px 0;font-size:0.875em;color:#374151;vertical-align:top;">Wednesday after close</td></tr><tr><td style="padding:6px 12px 6px 0;font-size:0.875em;color:#1e293b;font-weight:700;white-space:nowrap;vertical-align:top;">MSFT</td><td style="padding:6px 0;font-size:0.875em;color:#374151;vertical-align:top;">Thursday after close</td></tr><tr><td style="padding:6px 12px 6px 0;font-size:0.875em;color:#1e293b;font-weight:700;white-space:nowrap;vertical-align:top;">V</td><td style="padding:6px 0;font-size:0.875em;color:#374151;vertical-align:top;">Friday before open</td></tr></table></div>`,
