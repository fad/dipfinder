...
function buildDummyVars(token: string): Record<string, string> {
  ...
  return {
    ...
    weekAhead: `<div style="margin-top:24px;"><h2 style="margin:14px 0 6px;font-size:0.7em;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:0.08em;">The week ahead</h2><p style="margin:0 0 8px;font-size:0.8em;color:#64748b;font-style:italic;">Earnings on your watchlist:</p><ul style="margin:0;padding-left:16px;"><li style="margin:0 0 5px;font-size:0.875em;color:#374151;line-height:1.65;"><strong style="color:#1e293b;">AAPL</strong> - Wednesday after close</li><li style="margin:0 0 5px;font-size:0.875em;color:#374151;line-height:1.65;"><strong style="color:#1e293b;">MSFT</strong> - Thursday after close</li><li style="margin:0 0 5px;font-size:0.875em;color:#374151;line-height:1.65;"><strong style="color:#1e293b;">V</strong> - Friday before open</li></ul></div>`,
