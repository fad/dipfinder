...
function buildDummyVars(token: string): Record<string, string> {
  ...
  return {
    ...
    weekAhead: `<div style="margin-top:24px;background:#ffffff;border:1px solid #e2e8f0;border-radius:10px;padding:4px 16px 2px;"><h2 style="margin:14px 0 2px;font-size:0.7em;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:0.08em;">The week ahead</h2><div style="padding:10px 0;border-top:1px solid #f1f5f9;"><table cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:100%;"><tr><td style="font-size:0.875em;font-weight:700;color:#1e293b;white-space:nowrap;padding-right:14px;width:1%;">AAPL</td><td style="font-size:0.875em;color:#374151;">Wednesday after close</td></tr></table></div><div style="padding:10px 0;border-top:1px solid #f1f5f9;"><table cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:100%;"><tr><td style="font-size:0.875em;font-weight:700;color:#1e293b;white-space:nowrap;padding-right:14px;width:1%;">MSFT</td><td style="font-size:0.875em;color:#374151;">Thursday after close</td></tr></table></div><div style="padding:10px 0;border-top:1px solid #f1f5f9;"><table cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:100%;"><tr><td style="font-size:0.875em;font-weight:700;color:#1e293b;white-space:nowrap;padding-right:14px;width:1%;">V</td><td style="font-size:0.875em;color:#374151;">Friday before open</td></tr></table></div></div>`,
